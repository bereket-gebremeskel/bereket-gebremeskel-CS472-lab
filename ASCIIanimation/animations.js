...
window.onload = ()=>{
 ...
 turboBtn.onclick = turbo;

};
// var bek = ["bek":"asdf","asd"]
function jugglerfun  (value){
    
    const textArea = document.getElementById("text-area");
    const animationSelect = document.getElementById("animation");
    const selecteValue = animationSelect.value;
    if(selecteValue == 'Juggler'){
        let count = 0;
        let jugglers = ANIMATIONS["Juggler"].split("=====\n");
        setInterval(() => {
            textArea.value =  jugglers[count++]; 
            if(jugglers.length == count){
                count = 0;
            }
        }, speed);
    }
